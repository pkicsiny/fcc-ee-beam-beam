...
import sys
sys.path.append("/afs/cern.ch/work/p/pkicsiny/private/git/harpy") # change this path to the installation folder of harpy, https://gitlab.cern.ch/jcoellod/harpy.git
