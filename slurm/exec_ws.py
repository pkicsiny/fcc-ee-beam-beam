...
# python3 ./exec_ws.py --jobid 0 --nthreads 0 --nmacroparts 1000 --nturns 500  --nslices 100 --outdir .
...
bbeamIP1_b1 = xf.BeamBeamBiGaussian3D(
        ...
        slices_other_beam_Sigma_11    = arg_n_slices*[sigma_x**2],
        slices_other_beam_Sigma_22    = arg_n_slices*[sigma_px**2],
        slices_other_beam_Sigma_33    = arg_n_slices*[sigma_y**2],
        slices_other_beam_Sigma_44    = arg_n_slices*[sigma_py**2],

        # not x-y coupling now
...
for i in range(arg_n_turns):
    line_b1.track(particles_b1, num_turns=1)
    curr_time = time.time()
    if not i%10:
